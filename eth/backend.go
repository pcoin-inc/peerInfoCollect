...
import (
	...
	"peerInfoCollect/internal/shutdowncheck"
	"peerInfoCollect/log"
	"peerInfoCollect/node"
	"peerInfoCollect/p2p"
	"peerInfoCollect/p2p/dnsdisc"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	eth := &Ethereum{
		...
		engine:            ethconfig.CreateConsensusEngine(stack, chainConfig, &ethashConfig, []string{}, false, chainDb),
