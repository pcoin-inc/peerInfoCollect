...
func newHandler(config *handlerConfig) (*handler, error) {
	...
	log.Info("checkpointNumber ----","checkpointNumber",h.checkpointNumber)
	...
	success := func() {
		...
		log.Info("success----","head num",head.NumberU64())
